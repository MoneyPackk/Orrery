import {
  ...
  MISSION_LIST_CHANNEL, MISSION_PROMOTE_CHANNEL, MISSION_PROPOSE_REPOSITORY_CHANNEL, MISSION_RUN_CHANNEL,
} from "./channels";
...
export function createDesktopApi(invoke: Invoke, smokeMode = false): DesktopApi {
  const api: DesktopApi = {
    ...
    missions: {
      ...
      list: () => invoke(MISSION_LIST_CHANNEL) as ReturnType<DesktopApi["missions"]["list"]>,
